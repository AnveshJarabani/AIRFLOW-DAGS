...
default_args={'owner':'airflow','retries':1,
    ...
    PH_TRENDS_ETL.set_downstream([PROCESS_DAYS_ETL, WC_LOAD_ETL, LABOR_PNL_ETL, WO_TRENDS_ETL])

    [PROCESS_DAYS_ETL, WC_LOAD_ETL, LABOR_PNL_ETL, WO_TRENDS_ETL] >> [CY_PNL_ETL, LM_PNL_ETL, KLA_PNL_ETL]
